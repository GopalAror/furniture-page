...
import latest1 from "../assets/image/latest1.webp";
import latest2 from "../assets/image/latest2.webp";
import latest3 from "../assets/image/latest3.webp";
...
const Latest = () => {
    ...
    const myshow = myproductdata.map((e, index) => (
        <div key={index} className=" px-3 py-12 ">
            <div className="pt-[18px] pb-[53px] px-[15px] xl:px-[23px] duration-300 hover:shadow-[6px_13px_38px_0px] hover:shadow-[#0000001f]" data-aos="zoom-out-down">
